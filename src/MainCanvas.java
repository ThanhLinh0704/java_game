...
public class MainCanvas extends javax.swing.JFrame {
    ...
    public MainCanvas() {
        initComponents();
        balls.add(new Ball(100, 100, 50, 255, 0, 0, getWidth(), getHeight(), true, false));
        balls.add(new Ball(300, 200, 70, 0, 0, 255, getWidth(), getHeight(), false, true));
        balls.add(new Ball(400, 700, 90, 0, 100, 0, getWidth(), getHeight(), true, true));
        balls.add(new Ball(600, 900, 80, 205, 179, 139, getWidth(), getHeight(), true, false));
